...
export function Toolbar({
  ...
  return (
    <div className="main-toolbar">
      ...
      <div className="toolbar-group">
        <button className="toolbar-icon-btn toolbar-icon-bold" onClick={onUndo} title="撤销 (Cmd+Z)">↩</button>
        <button className="toolbar-icon-btn toolbar-icon-bold" onClick={onRedo} title="重做 (Cmd+Shift+Z)">↪</button>
      ...
      <div className="toolbar-group">
        ...
        <button className={`toolbar-icon-btn toolbar-icon-wrap ${wordWrap ? "active" : ""}`} onClick={onToggleWordWrap} title="自动换行">↵</button>
